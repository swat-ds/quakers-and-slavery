...
<!-- InstanceBeginEditable name="doctitle" --><title>Quakers &amp; Slavery : Resources </title><!-- InstanceEndEditable -->
...
<span>
  ...
  <img class="floatleft" align="left" style="padding-right:70px" src="../../quakersandslavery/images/abcdef.png" alt="" title=""/>

  <h1>Resources</h1>
  <p>This section contains resources compiled to help explain and contextualize the materials in the Quakers &amp; Slavery Project.</p>
  <br />
  <br />
  <h2><a href="bibliography.php">Bibliography</a></h2> 
  
  <p>  Here is a full bibliography of digitized documents in this collection including organizational records, meeting minutes, personal correspondence, books and other publications. Each item is linked to a record in Triptych, a searchable online database of special collections from Bryn Mawr, Haverford, and Swarthmore Colleges. </p>
  <p>A <a href="Q&amp;SBibliography.pdf" target="_blank">printer friendly PDF</a> of the Bibliography is available.  
  </p>
  
 <br /> <br />
 
  <h2><a href="glossary.php">Glossary</a></h2> 
  <p>Brief descriptions of organizations, Quaker terminology and important vocabulary relating to Quakers &amp; Slavery can be found here.</p>
  <p> A <a href="../../quakersandslavery/resources/Q&amp;SGlossary.pdf" target="_blank">printer friendly PDF</a>  of the glossary is available. </p>
  <br /> <br />
  
  <h2><a href="image_list.php">Images</a></h2> 
  <p>Here is a full list of photographs, lithographs, drawings, and objects in the collection. Each item is linked to a record in Triptych, a searchable online database of special collections from Bryn Mawr, Haverford, and Swarthmore Colleges. </p>
  <p>A <a href="Q&amp;SList_Images.pdf" target="_blank">printer friendly PDF</a> of the list of images is available.  </p>
<p>All of the images contained in this Quakers and Slavery site are authorized for personal or classroom use. For more information on downloading or obtaining high resolution copies read these <a href="http://trilogy.brynmawr.edu/speccoll/quakersandslavery/primary_sources/copies_and_downloads.php">instructions.</a> </p>
<br />


 
  <h2><a href="map_world.php">Map</a></h2> 
  <p>See the geographical distribution of materials in this collection on the interactive world map. Click the United States on the world map for a more detailed view of resources by region.</p>
   
  <br /> <br />
  
  <h2><a href="timeline.php">Timeline</a></h2> 
  <p>Get a sense of the chronology of the antislavery movement within the Society of Friends and the United States at large in the Timeline, from 1657 to the 1860's. </p>
