...
<!-- InstanceBeginEditable name="doctitle" --><title>Quakers &amp; Slavery : [page title] </title><!-- InstanceEndEditable -->

<!--Style Sheet -->
<link href="/speccoll/qstest/QuakersSlavery_nosidebar.css" rel="stylesheet" type="text/css" />

<script type="text/javascript" src="/speccoll/qstest/scripts/common.js"></script>

<!--[if lt IE 7]>
<link rel="stylesheet" href="/styles/ie6.css" type="text/css" />
<link rel="stylesheet" href="http://www.haverford.edu/library/libraryie6.css" type="text/css" />
...
<div id="containerspc"><!--[if lt IE 7]><script type="text/javascript">ie6Resize();</script><![endif]-->
	<div id="top">
		<div id="searchbar_background"></div>
		<div id="searchbar">
	
    <form action="http://trilogy.brynmawr.edu/speccoll/qstest/results.php" id="cse-search-box">
  <div>
...
$breadcrumb->changeName=array('library'=>'Library Home', 'qstest'=>'Exhibit Home');
...
?>
       ...
       <div id="sectionheader"><a href="/speccoll/qstest/"><img src="lucretiamott3.png" alt="Quakers &amp; Slavery" class="png" />
   ...
   function menu($a)
        {
        $u = $_SERVER['PHP_SELF'];//gives me /speccoll/qstest/index.php
        $dir  = substr(strrchr(getcwd(), '/'), 1);//gives me qstest
        $currDir = explode("/", $a);
...
<div id="subnavbar">
<div  <?php menu("/speccoll/qstest/index.php"); ?> id="tab_index"><a href="/speccoll/qstest/index.php">Welcome</a></div>
<div  <?php menu("/speccoll/qstest/commentary/index.php"); ?> id="tab_commentary"><a href="/speccoll/qstest/commentary/index.php">Commentary</a>
  <span>
        <a href="/speccoll/qstest/commentary/introduction.php">Introduction</a> 
        <a href="/speccoll/qstest/commentary/themes/index.php">Themes</a>
        <a href="/speccoll/qstest/commentary/people/index.php">People</a> 
        <a href="/speccoll/qstest/commentary/organizations/index.php">Organizations</a>
  </span>
</div>
<div  <?php menu("/speccoll/qstest/primary_sources/index.php"); ?> id="tab_primarysources"><a href="/speccoll/qstest/primary_sources/index.php">Primary Sources</a>
  <span>
        <a href="/speccoll/qstest/primary_sources/collection_about.php">About the Collection</a> 
        <a href="/speccoll/qstest/primary_sources/browse_and_search.php">Browse &amp; Search</a>
        <a href="/speccoll/qstest/primary_sources/copies_and_downloads.php">Copies &amp; Downloads</a> 
        <a href="/speccoll/qstest/primary_sources/collection_help.php">Help Using the Collection</a> 
  </span>
</div>
<div  <?php menu("/speccoll/qstest/resources/index.php"); ?> id="tab_resources"><a href="/speccoll/qstest/resources/index.php">Resources</a>
  <span>
        <a href="/speccoll/qstest/resources/bibliography.php">Bibliography</a> 
        <a href="/speccoll/qstest/resources/glossary.php">Glossary</a>
        <a href="/speccoll/qstest/resources/image_list.php">List of Images</a>
        <a href="/speccoll/qstest/resources/map.php">Map</a>
        <a href="/speccoll/qstest/resources/timeline.php">Timeline</a> 
        
  </span>
</div>	
<div  <?php menu("/speccoll/qstest/about/index.php"); ?> id="tab_about" ><a href="/speccoll/qstest/about/index.php">About the Project</a>
<span>
        <a href="/speccoll/qstest/about/index.php">Project Description</a> 
        <a href="/speccoll/qstest/about/project_funding.php">Project Funding</a>
        </span>
</div>
</div>
...
<p>Funding for the Quakers and Slavery Project was provided by the Federal Institute of Museum and Library Services, through a program stipulated by the Library Services and Technology Act (LSTA). This program is administered in Pennsylvania through the Office of Commonwealth Libraries for assisting libraries in providing all users access to information, developing partnerships, and increasing information access for persons who have difficulty gaining it. </p>

<img src="http://trilogy.haverford.edu/speccoll/qstest/about/IMLS_Logo_2c.jpg" alt="IMLS Logo" /> 
