...
<!-- InstanceBeginEditable name="doctitle" --><title>Quakers &amp; Slavery : About : Contact Us </title><!-- InstanceEndEditable -->
...
<h1> Contact Us</h1>
<br />
<p> Questions?  Comments?  Let us know your thoughts on the materials presented here. </p>  
<br />
  <?php 
if ($_POST["email"]<>'') { 
	$ToEmail = 'hc-special@haverford.edu; friends@swarthmore.edu'; 
	$EmailSubject = 'Quakers and Slavery comment from contact_us form  '; 
...
<td><textarea name="comment" cols="65" rows="10" id="comment" class="bodytext"></textarea></td>
</tr>
<tr>
...
<br />
<br />
  <p> For more information on ordering copies of the materials featured on this site, please see our <a href="../primary_sources/copies_and_downloads.php">Copies &amp; Downloads</a> page.</p>
