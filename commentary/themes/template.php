...
<!-- InstanceBeginEditable name="doctitle" --><title>Quakers &amp; Slavery : add page title  </title><!-- InstanceEndEditable -->
...
<h3>
   <a href=".pdf" target="_blank"> <img class= "floatleft" src="../../images/printPDF_icon2.png" border="0" alt="" title="PDF" /></a> <a href=".pdf" target="_blank">Printer Friendly PDF</a>
   </h3>
...
<h2><a name="references"></a>References</h2>
 ...
 <p align="right"><a href="#top" target="_top">TOP</a> </p>
    ...
    <td width="130"><div align="left"><a class="body_con" href="http://triptych.brynmawr.edu/u?/HC_QuakSlav,11137" target="_blank"><img src="thumbs/qs-thumb-11137" title="Our Countrymen in Chains!" alt="Our Countrymen in Chains!" /></a></div></td>
      ...
      <tr>
        <td width="130" valign="top"><div align="left">New Title</div></td>
          <td width="70"></td>
 <td width="130" valign="top"><div align="left">New Title</div></td>
          <td width="70"></td>
           <td width="130" valign="top"><div align="left">New Title</div></td>
