...
<!-- InstanceBeginEditable name="doctitle" --><title>Quakers &amp; Slavery : Commentary </title><!-- InstanceEndEditable -->
...
<span>
  ...
  <!-- InstanceBeginEditable name="pagecontent" -->
   ...
   <p>The materials digitized in the Quakers and Slavery Project are presented in conjunction with commentary contributed by eminent scholars, Quaker researchers, and the project staff. Enrich your understanding of the primary source documents by learning more about the themes, people, and organizations associated with Quakers and Slavery. Each item is linked to records of primary source documents in Triptych, a searchable online database of special collections from Bryn Mawr, Haverford, and Swarthmore, Colleges.</p>

  <br />
 
 
  
   <table cellpadding="10" cellspacing="15" width="100%">
<tr><td width="200"><div align="left"><h2><a href="themes/index.php">Themes</a></h2></div></td>
<td width="200"><div align="left"><h2><a href="people/index.php">People</a></h2></div></td>
<td width="200"><div align="left"><h2><a href="organizations/index.php">Organizations</a></h2></div></td></tr>
...
<p>Connect to primary source documents and read scholarly commentary on topics such as John Woolman's influential essay of 1754, the rescue of Jane Johnson and her children in 1855, photographs of &quot;white slaves&quot; during the Civil War, and other topics.</p></div></td>

<td width="200"><div align="left">
<p>Learn more about notable Quaker abolitionists by connecting to primary source documents. Scholarly commentary is available for Benjamin Lay, John Woolman, Thomas Garrett, Isaac T. Hopper, Daniel Neall Sr. &amp; Daniel Neall Jr., and others. </p>
</div> </td>
 
<td width="200"><div align="left">
<p>Quakers were involved in many reform organizations in the 18th and 19th centuries. Explore the relationship maps included in this section to find out how notable abolitionists connect to the various organizations. </p></div>
</td>
</tr>
