...
<!-- InstanceBeginEditable name="doctitle" --><title>Quakers &amp; Slavery : About the Collection </title><!-- InstanceEndEditable -->
...
<span>
       ...
       <div id="main">
          <div id="content"> 
    <div id="pagecontent"> 
  <!-- InstanceBeginEditable name="pagecontent" --><h1>About the Collection</h1> <p> The goal of this project is to increase public accessibility to rare historical materials formerly available only on-site at the Friends Historical Library at Swarthmore College and the Quaker &amp; Special Collections at Haverford College. The types of materials covered in the project include: photographs and lithographs, organization records, personal correspondence, and other publications. A full <a href="../resources/bibliography.php">bibliography</a> of the digitized documents, as well as a <a href="../resources/image_list.php">list of images</a>, is available in the <a href="../resources/index.php">Resources</a> section of this site.</p>

<p>All the materials in the Quakers and Slavery Project have been uploaded to Triptych, a searchable online database of special collections from Bryn Mawr, Haverford, and Swarthmore Colleges. Triptych utilizes CONTENTdm software; <a href="help.php">basic help</a> and <a href="http://triptych.brynmawr.edu/cdm4/help.php" target="_blank">advanced instructions</a> for using the software are both available online. In addition, a set of popular searches are available on the <a href="browse_and_search.php">Browse &amp; Search</a> page that link directly to the digital materials on the <a href="http://triptych.brynmawr.edu/cdm4/browse.php?CISOROOT=/HC_QuakSlav" target="_blank">Triptych</a> server.</p>
<p>&nbsp;</p>
 <div id="topBorder">
    <br />
    <a name="sources"></a>
     ...
     <table border="0" cellpadding="0" cellspacing="1">
      ...
      <tr>
        <td width="130" valign="top" ><div align="left">Germantown Protest </div></td>
            <td width="70"></td>
        <td width="130" valign="top"><div align="left">&quot;History of the Rise, Progress, &amp; Abolition of the African Slave Trade&quot;</div></td>
        <td width="70"></td>
        <td width="130" valign="top" ><div align="left">Legal and Financial Records of the Pennsylvania Hall Association </div></td>
        <td width="70"></td>
        <td width="130" valign="top" ><div align="left">Moses Sheppard Correspondence</div></td>
        
        <td width="70"></td>
        <td valign="top"><div align="left">Abner Woolman's Journal</div></td>
      </tr>
    </table>	
    </div>
  <!-- InstanceEndEditable -->
