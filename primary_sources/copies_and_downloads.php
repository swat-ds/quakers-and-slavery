...
<!-- InstanceBeginEditable name="doctitle" --><title>Quakers &amp; Slavery : Copies &amp; Downloads </title><!-- InstanceEndEditable -->
...
<span>
 ...
 <h1>Copies and Downloads</h1>
<h2>Copies of Images for Personal or Classroom Use</h2>
<p>All of the images contained in this Quakers and Slavery site are authorized for personal or classroom use. You can easily download low-resolution versions (72 dpi) through <a href="http://triptych.brynmawr.edu/cdm4/browse.php?CISOROOT=%2FHC_QuakSlav" target="_blank">Triptich</a>, a searchable online database of special collections from Bryn Mawr, Haverford, and Swarthmore Colleges. Once the image has been located in Triptich, simply right-click on the image and select "Save Image As..." &mdash; or, if you are using a Mac, press the control key and click [CTRL + click] then select "Save Picture As..." Delete the default name of the image file, "getimage.exe" and replace it with your name for the file and put the extension ".jpg" at the end [yourfilename.jpg].</p>

<h2>Ordering Hi-Resolution Copies and Obtaining Permission to Publish</h2>
<p>Higher quality versions are available from the repository which holds the original at a base cost of $10.00 per image, plus an additional commercial-use fee when applicable. Purchasing digital copies does not constitute permission to publish; each library has its own image request form, which also contains information about usage rights and restrictions. You may download the forms as PDFs from the links below, but you must print and mail the completed form, along with a check for the appropriate amount, to the repository that holds the original of the image you are requesting.</p>

          <ul>
            <li><a href="FHL_Photo_request2.pdf" target="_blank">Friends Historical Library of Swarthmore College Image Request Form</a></li>
            <li><a href="HV_digital_request3.pdf.pdf" target="_blank">Haverford College Quaker Collection Image Request Form</a></li>
          </ul>

<p>To fill out the forms, you will need to know the &quot;Repository,&quot; &quot;Title,&quot; and &quot;Identifier&quot;. Depending on whether the image is a single-page item, or part of a multiple-page document, you will find this information in different places.</p>
<p><strong>What is the &quot;Identifier&quot;?</strong> The identifier is a unique number assigned to each digitized page. The identifier begins with the prefix SW (for the Friends Historical Library of Swarthmore College), or HC (for Haverford College Special Collections). Record the entire identifier including all digits and underscores. The identifier may sometimes be the same as the page &quot;Title&quot; or &quot;Alternate title&quot;.</p>


<table cellspacing="20">

<tr>
      <td><img src="../images/multiitem.gif" width="400" height="251" alt="Multi-Page Document"/></td>
<td valign="top"><blockquote>
  <h3>Multiple-Page Documents</h3>
  <p>If the image you are requesting is one page from a multiple-page document, like this page from the Chesterfield Manumissions, there is an extra step. From the pull-down menu next to &quot;View:&quot; select &quot;page description&quot; and click &quot;go&quot;. The diagram to the left shows where you can find the needed information in the page description. More detailed information about viewing multiple-page documents is available on the <a href="help.php#view">help page</a>.</p>
</blockquote></td>
</tr>
<tr><td></td></tr>
<tr>
      <td><img src="../images/singleimage.gif" width="400" height="483" alt="Single Page Item"/></td>
<td valign="top"><blockquote>
  <h3>Single-Page Item</h3>
  <p>If the image you are requesting is a single page, like this view of the kneeling slave, you can find all the information you need by simply scrolling to the bottom of the webpage on Triptych. The diagram to the left shows where you can find the &quot;Repository,&quot; &quot;Title,&quot; and &quot;Identifier&quot; or &quot;Alternate Title&quot; information you will need to fill out the request form.</p>
</blockquote></td>
</tr>
</table>
